              ...
              <div className="p-6 lg:p-8 rounded-3xl bg-gradient-to-br from-bpc-navy-900 to-bpc-navy-800 text-white">
                ...
                <div className="space-y-4">
                  ...
                  <a
                    ...
                    className="flex items-center gap-4 p-4 rounded-xl bg-bpc-teal/20 hover:bg-bpc-teal/30 transition-colors group border border-bpc-teal/30"
                  >
                    <div className="w-12 h-12 rounded-xl bg-bpc-teal/30 flex items-center justify-center" aria-hidden="true">
                      <CalendarIcon className="w-6 h-6 text-bpc-teal-300" />
                    </div>
                    <div>
                      <p className="text-sm text-bpc-teal-300">{t('direct.schedule_description')}</p>
                      <p className="font-semibold text-white group-hover:text-bpc-teal-300 transition-colors">
                        {t('direct.schedule_meeting')}
                      </p>
                    </div>
                  </a>
                </div>
